...
# build APK
msbuild /p:Configuration=Release /p:Platform=Android /t:Rebuild ../../Sensus.Android/Sensus.Android.csproj
if [ $? -ne 0 ]; then 
...
# sign APK
msbuild /p:Configuration=Release /p:Platform=Android /p:AndroidKeyStore=true /p:AndroidSigningKeyAlias=sensus /p:AndroidSigningKeyPass=$3 /p:AndroidSigningKeyStore=$2 /p:AndroidSigningStorePass=$3 /t:SignAndroidPackage ../../Sensus.Android/Sensus.Android.csproj
if [ $? -ne 0 ]; then
