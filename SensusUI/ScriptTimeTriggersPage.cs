...
namespace SensusUI
{
    ...
    /// </summary>
    public class ScriptTimeTriggersPage : ContentPage
    {
        /// <summary>
        ...
        public ScriptTimeTriggersPage(ScriptRunner scriptRunner)
        {
            ...
            triggerList.ItemsSource = scriptRunner.TimeTriggers;
            triggerList.ItemTapped += async (o, e) =>
                {
                    if (triggerList.SelectedItem == null)
                        return;

                    SensusService.Probes.User.TimeTrigger selectedTrigger = triggerList.SelectedItem as SensusService.Probes.User.TimeTrigger;
                    ...
                    if (selectedAction == "Delete")
                    {
                        ...
                        {
                            scriptRunner.TimeTriggers.Remove(selectedTrigger);
            ...
            ToolbarItems.Add(new ToolbarItem(null, "plus.png", async () =>
                {
                    await Navigation.PushAsync(new SensusUI.AddScriptTimeTriggerPage(scriptRunner));
                }));
        }
    }
}