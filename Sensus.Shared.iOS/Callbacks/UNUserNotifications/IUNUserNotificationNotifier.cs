...
namespace Sensus.iOS.Callbacks.UNUserNotifications
{
    ...
    public interface IUNUserNotificationNotifier : IiOSNotifier
    {
        ...
        void IssueNotificationAsync(string title, string message, string id, bool playSound, DisplayPage displayPage, TimeSpan delay, NSMutableDictionary info, Action<UNNotificationRequest> requestCreated = null);
