...
namespace Sensus.Shared.iOS.Callbacks.UILocalNotifications
{
    ...
    {
        private readonly Dictionary<string, UILocalNotification> _callbackIdNotification;
        ...
        protected override void ScheduleCallbackAsync(ICallbackData meta)
        {
            ...
            SensusContext.Current.MainThreadSynchronizer.ExecuteThreadSafe(() =>
            {
                ...
                new iOSCallbackData(callbackNotification)
                {
            ...
            SensusContext.Current.MainThreadSynchronizer.ExecuteThreadSafe(() =>
            {
                ...
                lock (_callbackIdNotification)
                {
                    foreach (string callbackId in _callbackIdNotification.Keys)
                    {
                        ...
                        {
                            var meta = new iOSCallbackData(notification.UserInfo);
