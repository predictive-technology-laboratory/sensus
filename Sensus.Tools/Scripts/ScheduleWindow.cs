...
{
    public class ScheduleWindow : IComparable<ScheduleWindow>
    {
        #region Static Methods
        public static ScheduleWindow Parse(string window)
        {
        ...
        public int CompareTo(ScheduleWindow comparee)
        {
