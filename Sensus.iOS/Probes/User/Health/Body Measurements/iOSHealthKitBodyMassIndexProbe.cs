...
//Check the HKUnit for thhis class
...
namespace Sensus.iOS.Probes.User.Health
{
    public class iOSHealthKitBodyMassIndexProbe : iOSHealthKitSamplingProbe
    {
        ...
        public iOSHealthKitBodyMassIndexProbe()
            : base(HKObjectType.GetQuantityType(HKQuantityTypeIdentifierKey.BodyMassIndex))
        {
        }
        ...
        protected override Datum ConvertSampleToDatum(HKSample sample)
        {
            ...
            if (quantitySample == null)
                ...
                return new BodyMassIndexDatum(new DateTimeOffset(quantitySample.StartDate.ToDateTime()), quantitySample.Quantity.GetDoubleValue(null));
        }
    }
}