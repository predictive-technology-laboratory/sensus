...
namespace Sensus.iOS.Probes.User.Health
{
    public class iOSHealthKitFlightsClimbedProbe : iOSHealthKitSamplingProbe
    {
        protected override string DefaultDisplayName
        {
            get
            {
                return "Flights Climbed (HealthKit)";
            }
        }
        ...
        public iOSHealthKitFlightsClimbedProbe()
            : base(HKObjectType.GetQuantityType(HKQuantityTypeIdentifierKey.FlightsClimbed))
        {
        }
        ...
        protected override Datum ConvertSampleToDatum(HKSample sample)
        {
            ...
            if (quantitySample == null)
                ...
                return new HeightDatum(new DateTimeOffset(quantitySample.StartDate.ToDateTime()), quantitySample.Quantity.GetDoubleValue(null));
        }
    }
}