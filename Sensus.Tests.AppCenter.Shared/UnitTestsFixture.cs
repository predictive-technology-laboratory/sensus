...
namespace Sensus.Tests.AppCenter.Shared
{
    ...
    public class UnitTestsFixture
    {
        ...
        public void UnitTests()
        {
            ...
            Assert.True(testsRun == 144);  // will need to update this as we develop. ensures that tests are actually run.
#elif __ANDROID__
            string[] resultParts = logLines.Last().Split(',');
            ...
            Assert.True(testsRun == 145);  // will need to update this as we develop. ensures that tests are actually run.
#endif
