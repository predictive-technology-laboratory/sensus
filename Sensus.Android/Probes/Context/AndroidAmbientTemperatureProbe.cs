...
namespace Sensus.Android.Probes.Context
{
    public class AndroidAmbientTemperatureProbe : ListeningAmbientTemperatureProbe
    {
        ...
        {
            _temperatureListener = new AndroidSensorListener(SensorType.AmbientTemperature, null, e =>
            {
                ...
                StoreDatumAsync(new AmbientTemperatureDatum(DateTimeOffset.UtcNow, e.Values[0]));
            });
        }
