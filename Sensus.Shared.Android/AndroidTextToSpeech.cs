...
{
    public class AndroidTextToSpeech<MainActivityT> : UtteranceProgressListener, TextToSpeech.IOnInitListener where MainActivityT : FormsApplicationActivity
    {
        ...
        public AndroidTextToSpeech(AndroidSensusService<MainActivityT> service)
        {         
