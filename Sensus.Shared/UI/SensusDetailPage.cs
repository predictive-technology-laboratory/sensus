...
namespace Sensus.UI
{
	public class SensusDetailPage : ContentPage
	{
		private ListView _menuItemListView;

		public ListView MenuItemListView
		{
			get
			{
				return _menuItemListView;
			}
		}

		public SensusDetailPage()
		{
			...
			detailPageItems.Add(new SensusDetailPageItem
			{
				...
				Action = async () =>
				{
					await Launcher.OpenAsync(new Uri("https://predictive-technology-laboratory.github.io/sensus/articles/privacy-policy.html"));
				}
			});
			...
			_menuItemListView = new ListView(ListViewCachingStrategy.RecycleElement)
			{
