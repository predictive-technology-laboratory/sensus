...
#if DEBUG
			ToolbarItems.Add(new ToolbarItem("Add Missing Probes", "plus.png", async () =>
			{
				await protocol.AddMissingProbesAsync();

				ProbesList.ItemsSource = new ObservableCollection<Probe>(protocol.Probes);
			}));
#endif
		}
