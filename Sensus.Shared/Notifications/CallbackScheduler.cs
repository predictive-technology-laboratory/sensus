...
namespace Sensus.Shared.Callbacks
{
    public abstract class CallbackScheduler : ICallbackScheduler
    {
        ...
        public virtual void RaiseCallbackAsync(INotifyMeta meta, bool notifyUser, Action<DateTime> scheduleRepeatCallback, Action letDeviceSleepCallback, Action finishedCallback)
        {
