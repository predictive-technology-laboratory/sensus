...
namespace Sensus.Probes
{
    ...
    public abstract class Probe : INotifyPropertyChanged
    {
        ...
        public Task StoreDatumAsync(Datum datum, CancellationToken? cancellationToken = null)
        {
            ...
            return MostRecentDatumChanged?.Invoke(previousDatum, _mostRecentDatum) ?? Task.CompletedTask;
        }
