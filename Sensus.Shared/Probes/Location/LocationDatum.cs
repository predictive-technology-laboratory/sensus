...
namespace Sensus.Probes.Location
{
    ...
    public class LocationDatum : ImpreciseDatum
    {
        ...
        [Anonymizable(null, new Type[] { typeof(RebasingGpsParticipantLatitudeAnonymizer), typeof(RebasingGpsStudyLatitudeAnonymizer), typeof(DoubleRoundingTenthsAnonymizer), typeof(DoubleRoundingHundredthsAnonymizer), typeof(DoubleRoundingThousandthsAnonymizer) }, -1)]
        ...
        [DoubleProbeTriggerProperty]
        [Anonymizable(null, new Type[] { typeof(RebasingGpsParticipantLongitudeAnonymizer), typeof(RebasingGpsStudyLongitudeAnonymizer), typeof(DoubleRoundingTenthsAnonymizer), typeof(DoubleRoundingHundredthsAnonymizer), typeof(DoubleRoundingThousandthsAnonymizer) }, -1)]
