...
namespace Sensus.Probes.Location
{
    ...
    public class LocationDatum : ImpreciseDatum
    {
        ...
        [Anonymizable(null, new Type[] { typeof(GpsUseLatitudeAnonymizer), typeof(GpsStudyLatitudeAnonymizer), typeof(DoubleRoundingTenthsAnonymizer), typeof(DoubleRoundingHundredthsAnonymizer), typeof(DoubleRoundingThousandthsAnonymizer) }, -1)]
        ...
        [DoubleProbeTriggerProperty]
        [Anonymizable(null, new Type[] { typeof(GpsUseLongitudeAnonymizer), typeof(GpsStudyLongitudeAnonymizer), typeof(DoubleRoundingTenthsAnonymizer), typeof(DoubleRoundingHundredthsAnonymizer), typeof(DoubleRoundingThousandthsAnonymizer) }, -1)]
