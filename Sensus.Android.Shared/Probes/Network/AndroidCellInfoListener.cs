...
{
	public class AndroidCellInfoListener : TelephonyCallback, ICellInfoListener
	{
		...
		public async void OnCellInfoChanged(IList<CellInfo> cellInfo)
		{
			await _probe.CreateDatumsAsync(cellInfo);
		}
	}
}
